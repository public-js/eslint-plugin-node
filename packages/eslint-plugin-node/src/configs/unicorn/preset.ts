...
export const knownRulesESM: Linter.RulesRecord = {
...
export const unknownEntries: [string, Linter.RuleEntry][] = Object.entries(configs.recommended).filter(
    ([ruleId]: [string, Linter.RuleEntry]) => !knownRulesESM[ruleId],
) as [string, Linter.RuleEntry][];

const cjsOverride: Linter.RulesRecord = {
    'unicorn/prefer-module': 'off',
    'unicorn/prefer-node-protocol': 'off',
};
export const knownRulesCJS = (): Linter.RulesRecord => Object.assign({}, knownRulesESM, cjsOverride);
